...
public class SmartLeaves
{
    ...
    public static boolean isSameLeaves(IBlockState state1, IBlockState state2)
    {
        ...
        else
        {
            ...
            return block != block1 ? false : (block instanceof BlockOldLeaf ? ((EnumType)state1.getValue(BlockOldLeaf.VARIANT)).equals(state2.getValue(BlockOldLeaf.VARIANT)) : (block instanceof BlockNewLeaf ? ((EnumType)state1.getValue(BlockNewLeaf.VARIANT)).equals(state2.getValue(BlockNewLeaf.VARIANT)) : false));
        }
    }

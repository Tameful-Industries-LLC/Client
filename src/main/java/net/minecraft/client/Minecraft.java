...
import gg.tame.client.event.impl.ClickEvent;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    @Getter private final DefaultResourcePack mcDefaultResourcePack;
    ...
    private void setWindowIcon()
    {
        ...
        if (util$enumos != Util.EnumOS.OSX)
        {
            ...
            try
            {
                inputstream = this.mcDefaultResourcePack.getInputStream(new ResourceLocation("client/icons/window/icon-1.png"));
                inputstream1 = this.mcDefaultResourcePack.getInputStream(new ResourceLocation("client/icons/window/icon-2.png"));
    ...
    public void shutdownMinecraftApplet()
    {
        try
        {
            ...
            TameClient.getInstance().shutdown();
            ...
            while (Mouse.next())
            {
                ...
                if (Mouse.getEventButtonState())
                {
                    ...
                    else
                    {
                        ...
                        TameClient.getInstance().getEventBus().handleEvent(new ClickEvent(i));
                    }
                }
